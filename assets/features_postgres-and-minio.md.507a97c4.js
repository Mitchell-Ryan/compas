import{_ as n,c as s,o as a,a as e}from"./app.cf930e1c.js";const g='{"title":"Postgres and Minio","description":"","frontmatter":{},"headers":[{"level":2,"title":"Starting PostgreSQL","slug":"starting-postgresql"},{"level":2,"title":"Setup @compas/store","slug":"setup-compas-store"},{"level":2,"title":"Connecting","slug":"connecting"}],"relativePath":"features/postgres-and-minio.md"}',t={},o=e(`<h1 id="postgres-and-minio" tabindex="-1">Postgres and Minio <a class="header-anchor" href="#postgres-and-minio" aria-hidden="true">#</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Requires <code>@compas/store</code> to be installed</p></div><p>Most projects also require some way of persisting data. Compas aides in providing a PostgreSQL client and some utilities around setting up a database.</p><h2 id="starting-postgresql" tabindex="-1">Starting PostgreSQL <a class="header-anchor" href="#starting-postgresql" aria-hidden="true">#</a></h2><p>First that we need to make sure we have a running PostgreSQL instance. Compas helps here, by managing a Docker based PostgreSQL server. Previously you have already installed <code>@compas/cli</code>, which contains the necessary commands.</p><div class="language-shell"><pre><code>compas <span class="token function">docker</span> up
...
compas <span class="token function">docker</span> down
<span class="token comment"># Remove all created Docker containers and volumes</span>
compas <span class="token function">docker</span> clean
...
<span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token parameter">logger</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> sql <span class="token operator">=</span> <span class="token keyword">await</span> <span class="token function">newPostgresConnection</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    <span class="token literal-property property">createIfNotExists</span><span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span> <span class="token comment">// Create a new database if \`compastodo\` is not found</span>
...
</code></pre></div><p>This ties in various parts of your local environment. We don&#39;t have any tables yet in our database, so we execute a sum query and log the result. So let&#39;s run it:</p><div class="language-shell"><pre><code>compas database
<span class="token comment"># or</span>
<span class="token function">node</span> ./scripts/database.js

import{_ as n,c as e,o as s,a}from"./app.cf930e1c.js";const h='{"title":"Logger & events","description":"","frontmatter":{},"headers":[{"level":2,"title":"Logger","slug":"logger"},{"level":3,"title":"API","slug":"api"},{"level":3,"title":"setGlobalLogOptions","slug":"setgloballogoptions"},{"level":3,"title":"extendGlobalLoggerContext","slug":"extendgloballoggercontext"},{"level":3,"title":"On log levels and processing","slug":"on-log-levels-and-processing"},{"level":2,"title":"Events","slug":"events"}],"relativePath":"features/logger-and-events.md"}',t={},o=a(`<h1 id="logger-events" tabindex="-1">Logger &amp; events <a class="header-anchor" href="#logger-events" aria-hidden="true">#</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Requires <code>@compas/stdlib</code> to be installed</p></div><h2 id="logger" tabindex="-1">Logger <a class="header-anchor" href="#logger" aria-hidden="true">#</a></h2><p>Although the stdlib package exports more than just a logger, this document will focus on the logger.</p><h3 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h3><p>Provided by <code>@compas/stdlib</code></p><h4 id="newlogger" tabindex="-1">newLogger <a class="header-anchor" href="#newlogger" aria-hidden="true">#</a></h4><p>This function constructs a new logger. The logger supports a log context and pretty printing when asked.</p><p>Parameters:</p><ul><li><code>options</code>: <ul><li><code>disableInfoLogger</code> (boolean): Replaces <a href="http://log.info" target="_blank" rel="noopener noreferrer">log.info</a> with a &#39;noop&#39;. Defaults to &#39;false&#39;.</li><li><code>disableErrorLogger</code> (boolean): Replaces log.error with a &#39;noop&#39;. Defaults to &#39;false&#39;.</li><li><code>printer</code> (<code>&quot;pretty&quot;|&quot;ndjson&quot;|&quot;github-actions&quot;|undefined</code>): The log printer to use. Automatically inferred from the env variables.</li><li><code>stream</code> (Stream): The stream to write to, defaults to <code>process.stdout</code>. This is the intended use case. Although streams to files may work, this is not supported. This option is ignored if the printer is <code>ndjson</code>.</li><li><code>ctx</code> (object): Any context to add to log lines. This value is copied immediately on logger creation, so changes made via a reference, will not be reflected.</li></ul></li></ul><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Make sure to have a <code>.env</code> file with <code>NODE_ENV=development</code> in it for local development so log lines are readable.</p></div><p>A logger is a plain JavaScript object with 3 functions:</p><p><strong>info</strong> and <strong>error</strong>:</p><p>The info and error function accept a single argument that is logged. This happens in a single <code>write</code> call when pretty printing or not.</p><h3 id="setgloballogoptions" tabindex="-1">setGlobalLogOptions <a class="header-anchor" href="#setgloballogoptions" aria-hidden="true">#</a></h3><p>There is also some global log configuration that can be set. For now these options only apply to the &#39;ndjson&#39; logger. You can specify a custom Pino transport or destination that is used for all loggers created after calling this function. See the <a href="https://getpino.io" target="_blank" rel="noopener noreferrer">Pino docs</a> for more information on what you can pass in.</p><h3 id="extendgloballoggercontext" tabindex="-1">extendGlobalLoggerContext <a class="header-anchor" href="#extendgloballoggercontext" aria-hidden="true">#</a></h3><p>An application is able to gradually add more information to the shared context used by loggers. All properties added via this function will end up in each log line like the &#39;ctx&#39; option of &#39;newLogger&#39;. You can still overwrite values via the <code>ctx</code> option of <code>newLogger</code>. The added properties will only show up in loggers created after calling this function.</p><h3 id="on-log-levels-and-processing" tabindex="-1">On log levels and processing <a class="header-anchor" href="#on-log-levels-and-processing" aria-hidden="true">#</a></h3><p>Log levels are used to get some ranking based on importance in your log lines. Compas only knows 2 log levels: info and error. A log line is either important enough to warn you, or it is not. By simplifying this decision, you can spend a bit more time deciding if you really need to log that information or not.</p><p>There is much more information in logs than just the contrasting error- and info-&#39;level&#39;, however this always requires further processing. Compas prefers that this happens outside the current process. That is why by default we write everything to <code>stdout</code>. To accommodate processing, every log line is a valid JSON string, also called newline delimited JSON or NDJSON for short. The log line is structured as follows:</p><div class="language-json5"><pre><code><span class="token comment">// Created with \`log.info({ hello: &quot;world&quot; });\`</span>
